...
| Canonical personality extraction, structured response, workbench | `app/modules/library/personality_normalization.py`, `personality_workbench.py`, `runtime/run_normalize_personalities.py` | `tests/test_library_personality_normalization.py`, `tests/test_library_personality_workbench.py` |
