...
- Current Alembic head: `20260919_0050`.
...
Before revision `20260908_0046`, Manzara operational tables lived in the configured schema. That revision deletes cloud definitions, runs, events, conveyor, Gemini coordination, and AI retry tables. Normalization, Library domain data, previews, and guarded cleanup state remain durable.
