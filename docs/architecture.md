...
| Editable task conveyor | `app/conveyor.py` executes the singleton staged plan; persistence lives in `app/repositories/conveyor.py`; the task page owns its editor |
