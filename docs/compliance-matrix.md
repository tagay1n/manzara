...
| LC-BE-01 | Prefer declarative registries/maps over branching for flow/task definitions | PASS | `app/modules/maintenance/tasks.py`, `app/modules/library/tasks.py` | Task seeds are declarative dict/list structures. |
