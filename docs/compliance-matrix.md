...
1. Frontend foundation extraction (phase 3):
   - Continue reducing frontend domain-specific duplication so backend API/SSE remains the only source of truth for derived status/transforms (remaining `FE-02` gap).
